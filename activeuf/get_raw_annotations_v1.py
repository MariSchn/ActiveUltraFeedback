...
Example run command:
    python -m activeuf.get_raw_annotations_v1 \
...
if __name__ == "__main__":
    ...
    #         args.model_name, args.model_class, download_dir=args.download_dir)
    # else:
    ...
    all_raw_annotations = get_response_texts(
        model, tokenizer, all_messages, sampling_params)
