...
accelerate launch --config_file=$SCRATCH/ActiveUltraFeedback/activeuf/reward_model/multi_gpu.yaml resources/reward-bench/scripts/run_v2.py --model="$MODEL_NAME" --max_length=4096