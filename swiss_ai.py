...
if __name__ == "__main__":
    ...
    if args.w_principles:
        print("Using principles")
        all_messages = [
            [
    ...
    # idx2new_completion = dict(zip(range(len(dataset)), all_completions))

    # Add a new column "completion" to the dataset with the full Completion objects (as dicts)
    dataset = dataset.add_column("completion", all_completions)
