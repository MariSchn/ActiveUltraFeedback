...
#SBATCH --job-name=Kimi-K2-Instruct
#SBATCH --output=./logs/completions/Kimi-K2-Instruct/%j.out
...
python -u -m activeuf.generate_completions \
  ...
  --output_path /iopsstor/scratch/cscs/smarian/datasets/completions/Kimi-K2-Instruct \
  --seed 1983 \
