...
class NormedDPOTrainer(DPOTrainer):
    ...
    def get_batch_loss_metrics(
        ...
        metrics[f"{prefix}kl/chosen"] = self.accelerator.gather_for_metrics(kl_chosen).mean().item()
        metrics[f"{prefix}kl/rejected"] = self.accelerator.gather_for_metrics(kl_rejected).mean().item()
        metrics[f"{prefix}kl/overall"] = self.accelerator.gather_for_metrics(kl_all).mean().item()
