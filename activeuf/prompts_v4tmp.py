...
Evaluate alignment between a text and the task intent. Assess understanding of task goal and restrictions.
...
**Scoring**: Rate outputs on a scale of 1 to 5 (or "N/A"):
