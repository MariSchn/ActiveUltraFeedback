...
srun --environment=activeuf_dev python swiss_ai.py --dataset_path /iopsstor/scratch/cscs/smarian/datasets/swiss_ai/olmo_split1 --model_name Qwen/Qwen3-32B --output_path /iopsstor/scratch/cscs/smarian/datasets/swiss_ai/raw/Qwen3-32B_1