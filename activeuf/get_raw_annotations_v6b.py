...
"Qwen/Qwen3-32B"
Example run command:
    python -m activeuf.get_raw_annotations_v6b \
...
if __name__ == "__main__":
    ...
    for prompt_completion in tqdm(dataset):
        ...
        example_completion = prompt_example_map[row["prompt_id"]]
