...
OUTPUT_DIR="$SCRATCH/models/reward_models/preference_random_llama5"
REWARD_CONFIG="$SCRATCH/ActiveUltraFeedback/activeuf/reward_model/reward_config.yaml"
DATASET_PATH="$SCRATCH/datasets/preference_random_llama/" #"$SCRATCH/datasets/preference_random_llama/"
