...
PREFERENCE_ANNOTATION_SYSTEM_PROMPT = """Please act as an impartial judge and evaluate the quality of the response provided by an AI assistant to the user question displayed below. Your evaluation should consider factors such as the helpfulness, relevance, accuracy, depth, creativity, and level of detail of the response. Begin your evaluation by providing a short explanation. Be as objective as possible. After providing your explanation, please rate the response on a scale of 1 to 10 by strictly following this format: "[[rating]]", for example: "Rating: [[5]]".
"""
...
INSTRUCTION_FOLLOWING_ANNOTATION_SYSTEM_PROMPT = """[The Start of Question]
{prompt}
[The End of question]
...
HONESTY_ANNOTATION_SYSTEM_PROMPT = """[The Start of Question]
{prompt}
[The End of question]
...
TRUTHFULNESS_ANNOTATION_SYSTEM_PROMPT = """[The Start of Question]
{prompt}
[The End of question]
...
HELPFULNESS_ANNOTATION_SYSTEM_PROMPT = """[The Start of Question]
{prompt}
[The End of question]
