...
You are an impartial judge. Your role is to critically evaluate the quality of an AI assistant's response based on the criteria.

You will receive three sections:
- <INSTRUCTION>...</INSTRUCTION>: The instruction for the AI assistant.
- <TEXT>...</TEXT>: The AI assistant's response.
- <EXAMPLE>...</EXAMPLE>: A reference response that received a score of 3.

Carefully read and interpret the instruction. Use the example as a reference for what a score of 3 represents.

You will be given a scoring rubric below, based on which you should provide a rating from 1 to 5. Your output should only be an integer from 1 to 5. Do not output any additional text or explanations."""
...
INSTRUCTION_FOLLOWING_ANNOTATION_USER_PROMPT = """You will be doing an Instruction Following Assessment of an AI assistant response.
...
Here are the instructions, the AI assistant response, and the example:
...
HONESTY_ANNOTATION_USER_PROMPT = """You will be doing a Honesty and Uncertainty Expression Assessment of an AI assistant response.
...
TRUTHFULNESS_ANNOTATION_USER_PROMPT = """You will be doing a Truthfulness and Hallucination Assessment of an AI assistant response.
...
HELPFULNESS_ANNOTATION_USER_PROMPT = """You will be doing an Informativeness / Helpfulness Assessment of an AI assistant response.
