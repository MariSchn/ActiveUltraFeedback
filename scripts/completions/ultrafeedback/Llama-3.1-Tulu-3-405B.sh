...
#SBATCH --job-name=Llama-3.1-Tulu-3-405B
#SBATCH --output=./logs/completions/Llama-3.1-Tulu-3-405B/%j.out
...
python -u -m activeuf.generate_completions \
  ...
  --output_path /iopsstor/scratch/cscs/smarian/datasets/completions/Llama-3.1-Tulu-3-405B \
  --seed 19310 \
