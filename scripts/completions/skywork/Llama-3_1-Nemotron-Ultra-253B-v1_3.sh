...
#SBATCH --job-name=Llama-3_1-Nemotron-Ultra-253B-v1_3
...
python -u -m activeuf.generate_completions \
  ...
  --output_path /iopsstor/scratch/cscs/smarian/datasets/1_partial_completions/skywork/Llama-3_1-Nemotron-Ultra-253B-v1_3 \
  --seed 29 \
