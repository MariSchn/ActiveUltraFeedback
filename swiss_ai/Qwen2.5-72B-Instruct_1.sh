...
srun --environment=activeuf_dev python swiss_ai.py --dataset_path /iopsstor/scratch/cscs/smarian/datasets/swiss_ai/olmo_split1 --model_name Qwen/Qwen2.5-72B-Instruct --output_path /iopsstor/scratch/cscs/smarian/datasets/swiss_ai/raw/Qwen2.5-72B-Instruct_1
