...
readonly ACCELERATE_CONFIG="${PROJECT_BASE_DIR}/activeuf/reward_model/multi_node.yaml"
readonly PYTHON_FILE="${PROJECT_BASE_DIR}/activeuf/reward_model/reward_trainer.py"
readonly REWARD_CONFIG="${PROJECT_BASE_DIR}/activeuf/reward_model/reward_config.yaml"
...
accelerate launch --config_file=${PROJECT_BASE_DIR}/activeuf/reward_model/multi_gpu.yaml resources/reward-bench/scripts/run_v2.py --do_not_save --model="$OUTPUT_DIR"
